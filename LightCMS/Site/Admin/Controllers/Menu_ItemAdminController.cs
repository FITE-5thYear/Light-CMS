    ...
    public class Menu_ItemAdminController : Controller
    {
        ...
        public IActionResult GetAddMenuItem()
        {
            using (var db = CMSContextFactory.Create(Settings.MySqlConnectionString))
            {
                ...
                return View("~/Site/Admin/Views/MenuItem/add.cshtml");
            }
        }
        ...
        //edit exist item
        [HttpGet]
        [Route("admin/menu-items/edit/{menu_items_id}")]
        public IActionResult GetEditItem(int menu_items_id)
        {
            using (var db = CMSContextFactory.Create(Settings.MySqlConnectionString))
            {
                ...
                return View("~/Site/Admin/Views/MenuItem/edit.cshtml");
            }
        }
        ...
        [HttpGet]
        [Route("admin/menu-items/delete/{menuItem_id}")]

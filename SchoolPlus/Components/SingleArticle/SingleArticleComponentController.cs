...
using SchoolPlus.Components.SingleArticle.Models;
using SchoolPlus.Config;
using System.Linq;

namespace SchoolPlus.Components.SingleArticle
{
        ...
        public static void Bootstrap(string connectionString)
        {
            using (var db = CMSContextFactory.Create(connectionString))
            {
                ...
                if (_item == null)
                {
                    ...
                    {
                        Id = 1,
                        Title = "Welcome To Light-CMS",
                        ShortContent = "Welcome to Light-CMS",
                        FullContent = @"Thank you for using Light-CMS, you can access the <strong>Admin Panel</strong> by navigating to <strong>/admin</admin><br>.
                                        This is a sample page which was generated automatically by Light-CMS.",
                        CategoryId = 1
                    };
                    db.Add(_item);
                }
